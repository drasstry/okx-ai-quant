...
class Settings(BaseSettings):
    ...
    MAX_TOTAL_EXPOSURE_RATE: float = Field(default=0.40, gt=0, le=3.0)
    MAX_NET_EXPOSURE_RATE: float = Field(default=0.25, gt=0, le=3.0)
    LOSS_STREAK_DAYS: int = Field(default=2, ge=1, le=10)
    LOSS_STREAK_RISK_MULTIPLIER: float = Field(default=0.5, gt=0, le=1.0)
